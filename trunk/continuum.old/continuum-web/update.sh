...
cp ~/.maven/repository/maven/jars/maven-model-2.0-SNAPSHOT.jar $runtime/apps/maven2/lib
cp ~/.maven/repository/maven/jars/maven-plugin-2.0-SNAPSHOT.jar $runtime/apps/maven2/lib
...
cp ../continuum-trigger/continuum-trigger-socket/target/*.jar $lib
